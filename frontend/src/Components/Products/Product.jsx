            ...
            <div className="product-details">
              ...
              <div className="product-actions">
                <div className="product-actions-container">
                  ...
                  >
                    <Button variant="outlined" size="small" startIcon={<FiHeart/>} fullWidth> Add To Wishlist</Button>
                  </div>
                  ...
                  >
                    <Button variant="outlined" size="small" startIcon={<FiShoppingCart/>} fullWidth> Add To Cart</Button>
                  </div>
                </div>
              </div>
            </div>
